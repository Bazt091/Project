...
class ReceptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reception" do
    assert_difference('Reception.count') do
      post receptions_url, params: { reception: { details_purchase_orders_id: @reception.details_purchase_orders_id, quantity_ok: @reception.quantity_ok } }
    end
  ...
  test "should update reception" do
    patch reception_url(@reception), params: { reception: { details_purchase_orders_id: @reception.details_purchase_orders_id, quantity_ok: @reception.quantity_ok } }
