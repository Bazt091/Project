...
class DispatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dispatch" do
    assert_difference('Dispatch.count') do
      post dispatches_url, params: { dispatch: { details_dispatch_orders_id: @dispatch.details_dispatch_orders_id, quantity_ok: @dispatch.quantity_ok } }
    end
  ...
  test "should update dispatch" do
    patch dispatch_url(@dispatch), params: { dispatch: { details_dispatch_orders_id: @dispatch.details_dispatch_orders_id, quantity_ok: @dispatch.quantity_ok } }
